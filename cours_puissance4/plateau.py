...
# Objet qui represente le puissance4
tab = puissance4.TableauPuissance4()

joueur = 0

# Ajoute un Jeton 
# colonne : Colonne dans laquelle ajoute un jeton
def ajouteUnJeton(colonne):

    # Pour savoir quel joueur joue
    global joueur
    joueur = (joueur + 1) %2

    print("TODO : On rajoute un jeton dans la column %s" %( colonne))
